...
## Poseidon2b Implementation
The circuit implementation is located in /examples/poseidon2b_circuit.
...
The benchmarking python script can be found in scripts/run_benchmark.py.
