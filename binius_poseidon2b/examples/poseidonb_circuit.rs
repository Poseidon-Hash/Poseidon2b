...
fn init_8x32_768(mut builder: &mut ConstraintSystemBuilder, log_size: usize) {
	...
	let _state_out =
		binius_circuits::hades::poseidonb_x7_32_768::permutation(&mut builder, log_size, state_in);
}
...
fn init_8x32_512(mut builder: &mut ConstraintSystemBuilder, log_size: usize) {
	...
	let _state_out =
		binius_circuits::hades::poseidonb_x7_32_512::permutation(&mut builder, log_size, state_in);
}
fn init_8x64_768(mut builder: &mut ConstraintSystemBuilder, log_size: usize) {
	...
	let _state_out =
		binius_circuits::hades::poseidonb_x7_64_768::permutation(&mut builder, log_size, state_in);
}
...
fn init_8x64_512(mut builder: &mut ConstraintSystemBuilder, log_size: usize) {
	...
	let _state_out =
		binius_circuits::hades::poseidonb_x7_64_512::permutation(&mut builder, log_size, state_in);
}
fn init_8x128_768(mut builder: &mut ConstraintSystemBuilder, log_size: usize) {
	...
	let _state_out = binius_circuits::hades::poseidonb_x7_128_768::permutation(
		&mut builder,
		log_size,
		state_in,
	);
...
fn init_8x128_512(mut builder: &mut ConstraintSystemBuilder, log_size: usize) {
	...
	let _state_out = binius_circuits::hades::poseidonb_x7_128_512::permutation(
		&mut builder,
		log_size,
		state_in,
	);
